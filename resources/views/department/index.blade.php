...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
			...
			<div class="container">
				<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addDep">Add Department</button>
				<!-- Modal -->
				<div class="modal fade" id="addDep" role="dialog">
	...
	<div class="row">
		<div class="col-md-12">
				...
				<div class="tile-body">
					<div class="table-responsive">
		    			...
		    			{{-- Edit Button with model box call --}}
							 ...
							 <button type="button" data-toggle="modal" data-target="#editDep{{ $datas->id }}" class="fa fa-pencil-square-o btn btn-primary">
			...
			{{-- Edit Model Box start ,this model box popup on edit button click --}}
				<div class="container">
					<div class="modal fade" id="editDep{{ $datas->id }}" role="dialog">
						<div class="modal-dialog">
							<!-- Modal content-->
							<div class="row">
								<div style="width: 131%;" class="modal-content">
