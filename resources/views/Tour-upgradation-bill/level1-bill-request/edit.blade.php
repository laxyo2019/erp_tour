...
<main class="app-content">
   <div class="app-title">
    <div>
          <h1><i class="app-menu__icon fa fa-comments-o"></i> Edit Tour Level_1 Upgradation Amount Bill</h1>
   </div>
      <div>
         {{-- Message show --}}
         <p>
               ...
               <div style="width: 100%;" class="modal-content">
                    <div class="col-md-12">
                           ...
                           <div class="tile-body mt-3">
                              <form class="row" action="{{route('level1-tour-upg-bill.update',$data->id)}}" method="post" enctype="multipart/form-data">
                                 @csrf
                                  @method('PUT')
