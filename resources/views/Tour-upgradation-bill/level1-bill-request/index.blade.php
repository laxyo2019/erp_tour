				...
				<div class="tile-body">
					<div >
						...
						<tr>
							...
							<td><a href="{{route('level1-tour-upg-bill.show',$datas->id)}}" target="_blank"><i class="fa fa-eye btn btn-primary" ></i></a>
							</td>
                           ...
                           <center>
							...
							@if($datas->level2_status == 0)
								<a href="{{route('level1-tour-upg-bill.edit',$datas->id)}}" class="btn btn-sm btn-outline-warning"><i class="fa fa-edit"></i> Edit</a>
				             	 <form method="post" action="{{ route('level1-tour-upg-bill.destroy',$datas->id) }}">
		                       		 @csrf
		                       		 @method('DELETE')
