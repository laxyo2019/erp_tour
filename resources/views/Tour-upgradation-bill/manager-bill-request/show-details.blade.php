...
<main class="app-content">
   <div class="app-title">
    <div>
          <h1><i class="app-menu__icon fa fa-comments-o"></i> Show Tour Upgradation Amount Bill</h1>
   </div>
      <div>
         {{-- Message show --}}
         <p>
                              ...
                              <form class="row" action="{{route('tour-bill-upgradation.store')}}" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="form-group col-md-3">
                                  ...
                                  <div class="form-group col-md-3">
                                    ...
                                    <input id="user_name" name="user_name" class="form-control" type="text"  value="{{$data->user_name }}" readonly=""> 
                                    @error('user_name')
                                    <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
                                 ...
                                 <div class="form-group col-md-3">
                                    ...
                                    <input id="total_amount" name="total_amount" class="form-control" type="text" placeholder="Enter amount" value="{{ $data->total_amount }}" required=""  readonly="">
                                    @error('total_amount')
                                    <span class="text-danger" role="alert">
                                    <strong>{{ $message }}</strong>
                                    </span>
