...
{{-- =================================== --}}
  {{-- START INSERT MODEL BOX --}}
      ...
      <div class="container">
        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#addGrade">Add Metropolitan Tour Rate</button>
        <!-- Modal -->
            ...
            <div class="row">
              <div style="width: 131%;" class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="col-md-12">
                    <div class="tile">
                      <h3 class="tile-title">Add Metropolitan Tour Rate</h3>
                      <div class="tile-body">
                      {{-- INSERT FORM --}}
                        <form class="row" action="{{route('metropolitan-tour-rate.store')}}" method="post">
                       @csrf
                          <div class="form-group col-md-6" >
                            ...
                            <div class="form-group col-md-6" >
                            <label for="Grade">Metropolitan Tour Rate</label>
                              <input type="text" name="metropolitan_tour_rate" id="metropolitan_tour_rate" class="form-control">
                              @error('metropolitan_tour_rate')
                                <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                              </span>
                              @enderror
                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                      ...
                      @foreach($TourRate as $datas1)
                        ...
                        <tr>
                          <td>{{ $i++}}</td>
                          <td>{{ $datas1->grade}}</td>
                          <td>{{ $datas1->metropolitan_tour_rate}}</td>
                          <td>
                          {{-- Delete form --}}
                       
                            <form method="post" action="{{ route('metropolitan-tour-rate.destroy',$datas1->id) }}">
                              @csrf
                              @method('DELETE')
                              ...
                              <div class="row">
                                <div style="width: 131%;" class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <div class="col-md-12">
                                      <div class="tile">
                                        <h3 class="tile-title">Update Rate</h3>
                                        <div class="tile-body">
                                        {{-- Update FORM --}}
                               
                                          <form class="row" action="{{route('metropolitan-tour-rate.update',$datas1->id)}}" method="post">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group col-md-6" >
                                                <label for="Grade">Grade</label>
                                                  <select name="grade" class="form-control" id="grade" required="" readonly="">
                                                  <option value="{{$datas1->grade}}" required=""> {{$datas1->grade}}</option>
                                                    @foreach($data as $datas)
                                             ...
                                             <div class="form-group col-md-6" >
                                                <label for="Grade">Metropolitan Tour Rate</label>
                                                  <input type="text" name="metropolitan_tour_rate" id="metropolitan_tour_rate" class="form-control" value="{{$datas1->metropolitan_tour_rate}}">
                                                  @error('metropolitan_tour_rate')
                                                    <span class="text-danger" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                  </span>
