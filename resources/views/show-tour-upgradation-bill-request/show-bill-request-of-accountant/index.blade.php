               ...
               <table class="table table-striped table-hover table-bordered table-responsive" id="sampleTable" >
                  ...
                  {{-- end for paid unpaid amount to accountant --}}
                        ...
                        <td>
                           ...
                           <form action="{{route('tour-req-upg-bill-varification')}}" method="POST">
                              @csrf
                           ...
                           <form action="{{route('manager-req-upg-bill-approve-by-level1')}}" method="POST">
                              @csrf
                           ...
                           <form action="{{route('manager-req-upg-bill-approve-by-level_2')}}" method="POST">
                              @csrf
