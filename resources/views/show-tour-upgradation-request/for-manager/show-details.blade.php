...
<div class="app-title">
   <div>
          <h1><i class="app-menu__icon fa fa-comments-o"></i>User  Tour Upgradation Request</h1>
        </div>
   <div>
      {{-- Message show --}}
      <p>
         ...
         <div class="table-responsive">
            <div class="container">
               <div class="modal-header">
                  {{-- <h4 class="modal-title">Manager Upgradation Request Details</h4> --}}
               </div>
               <!-- Modal body -->
               <div class="modal-body">
                  <div class="tile">
                     ...
                     <form class="row" action="{{route('tour-amount-bill.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-3">
                           <label class="control-label"><b>Tour Upgradation, From</b></label><br>
                           <span>{{$datas->tour_from}}</span>
                        </div>
                        <div class="form-group col-md-3">
                           <label class="control-label"><b>Tour Upgradation, To</b></label><br>
                       ...
                       {{--  <div class="form-group col-md-3" >
                        ...
                        <div class="form-group col-md-6" >
                           <label for="control-label"><b> Exception Justification for higher class(If any)  </b></label><br>
                           <span>{{$datas->exception_heigh_upgradaton}}</span>
                        </div>
                        <div class="form-group col-md-6" >
