...
<main class="app-content">
   <div class="app-title">
      <div>
          <h1><i class="app-menu__icon fa fa-comments-o"></i> Create Tour Upgradation Request</h1>
        </div>
      <div>
         {{-- Message show --}}
         <p>
               ...
               <div class="col-md-12">
                  <div class="tile">
                    <!--  <h3 class="tile-title">Tour Upgradation Form</h3> -->
                     <div class="tile-body ">
                        <form class="row" action="{{route('tour-manager-upgradation.store')}}" method="post">
                           @csrf
                           ...
                           {{--  <div class="form-group col-md-4" >
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <textarea name="exception_heigh_upgradaton" class="form-control" id="exception_heigh_upgradaton" rows="2" placeholder="Enter Exception Upgradaton for higher class"></textarea>
