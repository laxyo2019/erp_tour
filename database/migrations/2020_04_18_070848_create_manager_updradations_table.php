...
class CreateManagerUpdradationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tour_manger_upgradations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('manager_updradations');
    }
}
